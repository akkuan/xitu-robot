  ...
  <header class="site-header" :class="{ 'site-header--dark': theme === 'dark' }" :style="{ '--nav-text-color': navColor }">
    ...
    <nav class="site-nav">
      <ul class="site-nav__list">
        <li>
          <NuxtLink to="/" class="site-nav__link">Skywalker</NuxtLink>
        </li>
        <li><NuxtLink to="/intelligence" class="site-nav__link">{{ $t('nav.intelligence') }}</NuxtLink></li>
        <li><NuxtLink to="/solution" class="site-nav__link">{{ $t('nav.solution') }}</NuxtLink></li>
        <li><NuxtLink to="/company" class="site-nav__link">{{ $t('nav.company') }}</NuxtLink></li>
        <li><NuxtLink to="/news" class="site-nav__link">{{ $t('nav.news') }}</NuxtLink></li>
        <li><NuxtLink to="/careers" class="site-nav__link">{{ $t('nav.careers') }}</NuxtLink></li>
      </ul>
    </nav>
    ...
    <div class="site-header__right" style="display: flex; align-items: center; gap: 20px;">
      ...
      <div class="site-header__logo" style="font-size: 42px;">Xitu</div>
    </div>
